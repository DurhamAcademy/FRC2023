...
class SwerveModule(
    ...
    fun setMotorPower(drive: Double, angle: Double) {
        driveMotor.set(drive)
        turnMotor.set(angle)
    }
    fun move() {
        anglePid.setGoal(setpoint.angle.radians)
        drivePid.setGoal(setpoint.speedMetersPerSecond)
        ...
        setMotorPower(drivePower, anglePower)
    }
