...
class FindClosestNode {
    ...
    fun nearestNode(drivetrain: Drivetrain) : Double{
        var distances: DoubleArray = doubleArrayOf(3.0)
        distances[0] = abs(drivetrain.estimatedPose2d.y - PlacementGroup.Closest.offset)
        distances[1] = abs(drivetrain.estimatedPose2d.y - PlacementGroup.Middle.offset)
        distances[2] = abs(drivetrain.estimatedPose2d.y - PlacementGroup.Farthest.offset)
